...
<form method="post" action="writeBoard" onsubmit="return checkForm()">
	<div class="form-group">
		...
		<input id="btitle" name="btitle" type="text" class="form-control" placeholder="Write Title">
		<span id="btitleError" class="error" style="color: red"></span>
	</div>
	<div class="form-group">
		<label for="bcontent">Content</label>
		<textarea id="bcontent" name="bcontent" class="form-control" rows="8" placeholder="Write Content"></textarea>
